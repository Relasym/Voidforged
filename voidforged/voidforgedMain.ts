...
//Level Blocks
const wallBlockSrc: string[]= new Array();
...
const wallBlock: HTMLImageElement[] = new Array();
...
const wallBlockNew: HTMLImageElement[] = new Array();
...
//character
//walk
const characterSpritesWalkSrc: string[]= new Array();
...
const characterSpritesWalk: HTMLImageElement[] = new Array();
...
//turn
const characterSpritesTurnSrc: string[]= new Array();
...
const characterSpritesTurn: HTMLImageElement[] = new Array();
